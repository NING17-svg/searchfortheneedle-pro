...
export const sitePages: PageContent[] = [
  {
    ...
    seoTitle: `${site.gameName} FAQ | Player Onboarding Questions`,
    metaDescription:
      "Quick answers to the first-visit questions every Search For The Needle player asks: what the game is, whether it is free, the launch date, where to find active codes, which gamepass to buy first, and the Alien event.",
    summary:
      "Quick answers to the first-visit questions every Search For The Needle player asks.",
    hero: {
      eyebrow: "FAQ",
      subtitle:
        "Eight short answers to the first-visit questions on Search For The Needle, each linked out to a dedicated guide page.",
      ctas: [
    ...
    quickAnswer:
      "The /faq route answers the first-visit questions every Search For The Needle player asks: what the game is, whether it is free, the launch date, where to find active codes, which gamepass to buy first, the Alien event, the daily login Gems track, and the fastest way to sweep a haystack.",
    keyFacts: [
      { label: "Status", value: "Unofficial fan reference" },
      { label: "Source rule", value: "Official Roblox game page + Games API" },
      { label: "Review", value: "Re-checked 2026-09-20" },
      { label: "Codes status", value: "No active codes as of 2026-09-20" },
    ...
    modules: [
      {
        ...
        body: "Each answer below is a 1-3 sentence direct response that links out to the dedicated guide page for the full walkthrough, table, or updated status. Start with the question you need; if the answer points to a guide, that guide carries the dated status row and the source links.",
        links: [
          { label: "Active codes", href: "/codes" },
          { label: "How to play", href: "/how-to-play" },
    ...
    faqIds: [
      ...
      "faq-is-it-free",
      "faq-when-launch",
      "faq-where-find-codes",
      "faq-first-gamepass",
      "faq-alien-event",
      "faq-daily-login-track",
      "faq-haystack-sweep",
    ],
    relatedPageIds: [
