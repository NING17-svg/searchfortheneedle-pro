...
| `/codes` | `src/data/pages/content-pages.ts` | Guide | Search For The Needle codes | Track active codes | How to play / Pets / Updates | Supporting hub | Dated status; no active codes as of 2026-09-23. |
...
| `/currencies` | `src/data/pages/content-pages.ts` | Guide | Search For The Needle currencies | Pick what each currency funds | How to play / Classes / Pets / Gamepasses / Updates | Supporting hub | Four currencies: Cash (in-round), Gems (persistent), Diamonds (drops, no published spend), Alien Coins (limited-time). |
...
| `/updates` | `src/data/pages/content-pages.ts` | Guide | Search For The Needle updates | Check latest patch status | Codes / Chapter 2 / Locations / How to play | Supporting hub | Last build 2026-09-23T17:17:25.0998622Z (66,115,826 visits / 22,530 playing / 167,083 favorites); 11-row changelog (2026-09-23 universe, 2026-09-22T16:24 UTC CLANS mechanics follow-up, 2026-09-26 Chapter 3 calendar, 2026-09-20 CLANS / Update 3, and earlier dated rows) + full CLANS mechanics block (create at 500 Gems, daily clan quests, 10 Clan Tokens = 1 Clan Chest per member, six-drop chest table) + Alien event & Alien Coins block. |
...
- Classes should link to How to play, Gamepasses, Tips, and Currencies.
- Gamepasses should link to Classes, How to play, Pets, and Currencies.
- Pets should link to Gamepasses, How to play, Codes, and Currencies.
- Currencies should link to How to play, Classes, Pets, Gamepasses, and Updates.
- Updates should link to Codes, Chapter 2, Locations, and Currencies.
- FAQ should include all current high-demand answer pages.

## Open Questions

- Replace the Diamond spend caveat on `/currencies` with a real Diamond catalogue once Garage Games publishes the spend targets on the official Roblox game page or creator group channels.
